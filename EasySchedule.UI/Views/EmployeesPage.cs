...
public class EmployeesPage : ContentPage
{
    ...
    private void BuildUI()
    {
        ...
        var picker = new Picker { Title = "Wybierz profesję" };
        picker.SetBinding(Picker.ItemsSourceProperty, "Professions");
        picker.ItemDisplayBinding = new Binding("Name");
        picker.SetBinding(Picker.SelectedItemProperty, "SelectedProfession");
        ...
        var formCard = new Border
        {
            ...
            Content = new VerticalStackLayout { Spacing = 10, Children = { entryName, entrySurname, picker, addBtn } }
        };
